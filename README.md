...
&nbsp;
<a href="https://instagram.com/dido.hub">
...
&nbsp;
![GitHub followers](https://img.shields.io/github/followers/didohm?label=Followers&style=flat-square&color=58a6ff)
...
const boumedien = {
  ...
  interests : ["UI/UX Design", "Motion", "3D Web", "Product Engineering"],
  currently : "Building fast, scalable, and beautiful digital products",
  quote     : "Good software feels effortless. Great design feels invisible.",
};
```

- 🔨 Building **production-ready** web and mobile applications
- 🎨 Obsessed with **UI quality**, motion, and design-to-code workflows
- 🌐 Exploring **Three.js**, advanced animations, and visual storytelling
- 📐 Strong focus on **component architecture**, performance, and DX
- 🤝 Open to **collaboration** on impactful and ambitious projects
...
```
┌─────────────────────────────────────────────────────────────────┐
│  🧱  Improving UI systems & component architecture              │
│  ⚡  Building fast, scalable, and responsive products           │
│  🌀  Exploring advanced animations & Three.js                   │
│  🔗  Creating better design-to-code workflows                   │
│  📚  Mastering modern full-stack patterns & micro-frontends     │
└─────────────────────────────────────────────────────────────────┘
```
...
<p>I'm always open to interesting conversations, collaborations, or new opportunities.</p>
